...
[[ "$mem_kb" -ge 3800000 ]] || fail "Beta 16 requires at least 4 GB RAM for the automatic application stack."
free_kb="$(df -Pk / | awk 'NR==2{print $4}')"
[[ "$free_kb" -ge 20000000 ]] || fail "Beta 16 requires at least 20 GB free system storage."
