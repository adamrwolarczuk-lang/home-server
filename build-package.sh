...
dpkg-deb --root-owner-group --build "$BUILD" "$DIST/AYVAtech-Home-Server-Installer-3.0.0-beta.11.deb"
echo "Built: $DIST/AYVAtech-Home-Server-Installer-3.0.0-beta.11.deb"